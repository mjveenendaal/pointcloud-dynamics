# Based on code by Harry R. {https://stackoverflow.com/users/3004624/harry-r}
# source: https://stackoverflow.com/a/20146045
# and Erik Ward {https://github.com/ecward}
# source: https://gist.github.com/ecward/c373932638fd04a2243e
...
if __name__ == "__main__":
    ...
    #Run the icp
    p_opt,T_opt = icp(a, b,init_pose, no_iterations=20)
    a_opt = T_opt*a_h
